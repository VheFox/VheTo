---
title: Motrix多线程下载以及UC网盘提速
published: 2025-12-05T19:30:00+08:00
description: '启用Motrix多线程下载以及UC网盘网页下载提速'
image: './C3.jpg'
tags: ["狐说","软件"]
category: '文章'
draft: false 
...
只需要把drive改成fast即可直接下载，不用下载UC浏览器  
但是不用多线程下载器速度会很慢，下面是启用Motrix多线程下载器接管浏览器自带下载管理的办法  
## 启用Motrix多线程下载器（这里是百分浏览器，类似Chrome）
1. 前往官网下载需要的软件版本然后安装，网址：https://motrix.app/download
![](./P3-1.png)
