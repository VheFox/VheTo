...
export const siteConfig: SiteConfig = {
	title: "VheFox",
	subtitle: "",
	siteURL: "https://vhefox.com/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-11-20", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	banner: {
		...
		src: {
			desktop: ["/assets/desktop-banner/bg-1.jpg"], // 桌面横幅图片
			mobile: ["/assets/mobile-banner/bg-1.jpg"], // 移动横幅图片
		}, // 使用本地横幅图片
	...
	font: {
		...
		asciiFont: {
			...
			fontFamily: "SourceHanSerifSC-Medium", //"Fengyasong", //"SourceHanSansCN-Medium.otf", //"ZenMaruGothic-Medium", //"WenKai-Bold",
			fontWeight: "400",
			localFonts: ["SourceHanSerifSC-Medium.otf"], //["Fengyasong.ttf"],  //["SourceHanSansCN-Medium.otf"],  //["ZenMaruGothic-Medium.ttf"], //["WenKai-Bold.ttf"],
			enableCompress: true, // 启用字体子集优化，减少字体文件大小
		},
		cjkFont: {
			// 中日韩字体 - 作为回退字体
			fontFamily: "Fengyasong", //"WenKai-Bold",
			fontWeight: "500",
			localFonts: ["Fengyasong.ttf"], //["WenKai-Bold.ttf"],
			enableCompress: true, // 启用字体子集优化，减少字体文件大小
		},
	},
...
export const fullscreenWallpaperConfig: FullscreenWallpaperConfig = {
	src: {
		desktop: ["/assets/desktop-banner/bg-1.jpg"], // 桌面横幅图片
		mobile: ["/assets/desktop-banner/bg-1.jpg"], // 移动横幅图片
	}, // 使用本地横幅图片
	...
	links: [
		{
			name: "Bilibli",
			icon: "fa6-brands:bilibili",
			url: "https://space.bilibili.com/37300795",
		},

		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/vhefox",
		},
	],
};
